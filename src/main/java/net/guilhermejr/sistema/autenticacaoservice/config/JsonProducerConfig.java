...
public class JsonProducerConfig {
    ...
    @Bean
    public KafkaTemplate<String, Serializable> jsonKafkaTemplate(ProducerFactory<String, Object> jsonProducerFactory) {
    ...
    public KafkaAdmin.NewTopics topicos() {
        return new KafkaAdmin.NewTopics(
                TopicBuilder.name(topicoEsqueciMinhaSenha).partitions(1).build()
        );
    }
